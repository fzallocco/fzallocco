This is my first Node-based responsive single-page application that you can run upon executing npm start.
There are two options for you to run this application:
